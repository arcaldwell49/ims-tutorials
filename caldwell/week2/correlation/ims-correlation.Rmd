...
```{r decision-tree, echo=FALSE, out.width=600}
# You would create a simple decision flowchart image here
# For now, I'll describe it in text
```
...
Here's a comprehensive section on Spearman's rho and Kendall's tau that you can add to your tutorial:
